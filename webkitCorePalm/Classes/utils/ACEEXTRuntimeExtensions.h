 ...
 */
typedef void (*ace_failedMethodCallback)(Class, Method);

/**
 * Used with #ace_injectMethods to determine injection behavior.
 */
typedef NS_OPTIONS(NSUInteger, ace_methodInjectionBehavior) {
    /**
     * Indicates that any existing methods on the destination class should be
     * overwritten.
     */
    ace_methodInjectionReplace                  = 0x00,
    
    /**
     * Avoid overwriting methods on the immediate destination class.
     */
    ace_methodInjectionFailOnExisting           = 0x01,
    
    /**
     * Avoid overriding methods implemented in any superclass of the destination
     * class.
     */
    ace_methodInjectionFailOnSuperclassExisting = 0x02,
    
    /**
     * Avoid overwriting methods implemented in the immediate destination class
     * or any superclass. This is equivalent to
     * <tt>ace_methodInjectionFailOnExisting | ace_methodInjectionFailOnSuperclassExisting</tt>.
     */
    ace_methodInjectionFailOnAnyExisting        = 0x03,
    
    /**
     * Ignore the \c +load class method. This does not affect instance method
     * injection.
     */
    ace_methodInjectionIgnoreLoad = 1U << 2,
    
    /**
     * Ignore the \c +initialize class method. This does not affect instance method
     * injection.
     */
    ace_methodInjectionIgnoreInitialize = 1U << 3
};

/**
 * A mask for the overwriting behavior flags of #ace_methodInjectionBehavior.
 */
static const ace_methodInjectionBehavior ace_methodInjectionOverwriteBehaviorMask = 0x3;
...
typedef enum {
     ...
     */
    ace_propertyMemoryManagementPolicyAssign = 0,
    
    /**
     * The value is retained.
     */
    ace_propertyMemoryManagementPolicyRetain,
    
    /**
     * The value is copied.
     */
    ace_propertyMemoryManagementPolicyCopy
} ace_propertyMemoryManagementPolicy;
...
typedef struct {
     ...
     * #ace_propertyMemoryManagementPolicyAssign if #readonly is \c YES.
     */
    ace_propertyMemoryManagementPolicy memoryManagementPolicy;
 ...
 */
Class *ace_copySubclassList (Class aClass, unsigned *subclassCount);
 ...
 */
#define ace_getIvar(OBJ, IVAR, TYPE) \
 ...
 * or floating-point types.
 */
#define ace_getIvarByName(OBJ, NAME, TYPE) \
ace_getIvar((OBJ), class_getInstanceVariable(object_getClass((OBJ)), (NAME)), TYPE)
 ...
 */
unsigned ace_injectMethods (Class aClass, Method *methods, unsigned count, ace_methodInjectionBehavior behavior, ace_failedMethodCallback failedToAddCallback);

/**
 * Invokes #ace_injectMethods with the instance methods and class methods from
 * \a srcClass. #ace_methodInjectionIgnoreLoad is added to #behavior for class
 * method injection.
 *
 * Returns whether all methods were added successfully. For each method that fails
 * to be added, \a failedToAddCallback (if provided) is invoked.
 ...
 */
BOOL ace_injectMethodsFromClass (Class srcClass, Class dstClass, ace_methodInjectionBehavior behavior, ace_failedMethodCallback failedToAddCallback);
 ...
 *
 * @li Each protocol is loaded with #ace_loadSpecialProtocol and a custom block
 ...
 * #ace_specialProtocolReadyForInjection.
 ...
 * #ace_specialProtocolReadyForInjection as well.
 *
