...
//	NSString *charset = (NSString *)CFStringConvertEncodingToIANACharSetName(CFStringConvertNSStringEncodingToEncoding([self stringEncoding]));  //没用 CHB 20131228注去除警告 
	...
	//二进制上传问题 http://www.ietf.org/rfc/rfc1867.txt 
